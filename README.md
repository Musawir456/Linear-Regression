...
linearReg.py – Python script version

homeprices.csv – House price dataset

areas.csv – Area dataset

canada_per_capita_income.csv – Income dataset

prediction.csv – Model prediction output
...
Open: 1_Linear_regression.ipynb
